...
const BookingForm = () => {
  ...
  return (
    <div className="relative max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg space-y-8">
      
      {/* View Bookings Button at the Top Left */}
      <button
        onClick={() => router.push("/userbookings")}
        className="absolute top-4 left-4 bg-gray-300 font-bold text-gray-800 p-3 rounded-lg hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
      >
        View Your Bookings
      </button>

      <h2 className="text-4xl font-bold text-center text-gray-900 mb-8">Book a Table</h2>
      ...
      <form className="space-y-6">
        ...
        <button
          ...
          className="w-full bg-blue-600 text-white p-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
        >
          Get Available Slots
        </button>
              ...
              {availableSlots.map((slot) => (
                <button
                  ...
                  className={`w-20 h-20 rounded-full flex items-center justify-center text-lg font-semibold text-gray-700 border-2 
                    ${selectedTime === slot ? "bg-blue-600 text-white border-blue-600" : "bg-gray-100 border-gray-300 hover:bg-blue-200"} 
